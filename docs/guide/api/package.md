...
Возвращает массив расширений: по имени/паттерну, по директории, либо все в проекте. На невалидное окружение — пустой массив. На неправильный вызов с обоими `extension` и `path` — `throw ChefError(CF.OPTION_DENIED)`.
