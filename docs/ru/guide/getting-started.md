...
- [Обзор](/ru/guide/overview) — как устроены расширения и как работает сборка
- [JS-расширение](/ru/guide/project-structure) — структура расширения и все параметры `bundle.config.ts`
- [Настройка TypeScript](/ru/guide/typescript) — подробнее об алиасах и `tsconfig.json`
- [Настройка тестов](/ru/guide/test-setup) — как писать и запускать тесты