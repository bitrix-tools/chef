...
chef diag re-exports                           # Re-exports of symbols from other extensions
chef diag re-exports 'calendar.*'              # Only within calendar.*
chef diag re-exports 'im.v2.**' ui.text-editor # Multiple patterns at once
