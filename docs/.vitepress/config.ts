...
const sidebarRu = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Сценарные тесты', link: '/guide/testing-module' },
  ...
  },
  {
    ...
    collapsed: true,
    items: [
      { text: 'CLI --reporter', link: '/guide/json/reporter' },
      { text: 'Формат ответа', link: '/guide/json/response-format' },
      { text: 'Коды ошибок', link: '/guide/json/errors' },
    ],
  },
  {
    text: 'Конфигурация',
...
const sidebarEn = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Scenario Tests', link: '/en/guide/testing-module' },
  ...
  },
  {
    ...
    collapsed: true,
    items: [
      { text: 'CLI --reporter', link: '/en/guide/json/reporter' },
      { text: 'Response format', link: '/en/guide/json/response-format' },
      { text: 'Error codes', link: '/en/guide/json/errors' },
    ],
  },
  {
    text: 'Config',
